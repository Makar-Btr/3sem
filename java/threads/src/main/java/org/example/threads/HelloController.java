...
public class HelloController {
    ...
    // FXML элементы из hello-view.fxml
    @FXML
    private HBox visualArea;
    @FXML
    ...
    // --- Методы из SortingVisualizer.java ---
    ...
    private void startSorting() {
        // Запуск сортировок в отдельных потоках
    ...
    // Методы сортировки (Bubble, Quick, Heap) и вспомогательные методы
    // (partition, heapify, sleep) остаются точно такими же, как в SortingVisualizer.java
    // (Вставляем их сюда).

    // START: Вставляем методы сортировки из SortingVisualizer.java
    ...
    // END: Вставляем методы сортировки из SortingVisualizer.java

    // Класс SortPanel, перемещенный из SortingVisualizer.java
